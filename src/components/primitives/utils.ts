// FILE: src/components/primitives/utils.ts
export const ELLIPSIS = '...';
const MIN_SIZE_FOR_TRUNCATION = 12;

// [FIX] Added 'export' keyword to make this function available to other modules.
...
// END OF FILE: src/components/primitives/utils.ts